...
alter table list add constraint list_fk foreign key (color_id) references color (id);
...
insert into list(name, color_id) values
('Homework', 2),
('Front-end', 3),
('Sport', 1),
('Reading', 4),
...
insert into task(name, list_id) values
('Высшая математика', 1),
